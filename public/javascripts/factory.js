...
(function() {
  var $body, $document, DEFAULT_SLIDE, Editor, MainMenu, Presentation, PresentationsBrowser, Router, Settings, SlideViewer, SlidesBrowser, catchLinkClicks, localStorageSync, server,
    __slice = [].slice,
  ...
  window.Factory = {
    ...
    play: function() {
      return $body.removeClass('editing');
    }
  };
  ...
  server.once('request', function(req) {
    return console.log("CONNECTED: " + req.headers.host);
  });
  ...
  SlideViewer = (function(_super) {
    ...
    SlideViewer.prototype.initialize = function() {
      return this.bindNavigationKeys();
    };
    ...
    SlideViewer.prototype.bindNavigationKeys = function() {
      var _this = this;
    ...
    SlideViewer.prototype.isEditing = function() {
      return $body.is('.editing');
    };

    SlideViewer.prototype.nextSlide = function() {
      var currentSlide, presentation, slides;
      ...
      return Factory.Router.navigate(presentation.url(++currentSlide), true);
    };

    SlideViewer.prototype.previousSlide = function() {
      var currentSlide, presentation, slides;
      presentation = Factory.currentPresentation;
      currentSlide = Factory.currentSlide;
      slides = presentation.get('slides');
  ...
  MainMenu = (function(_super) {
    ...
    MainMenu.prototype.play = Factory.play;
