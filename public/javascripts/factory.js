...
(function() {
  var DEFAULT_SLIDE, Editor, MainMenu, Router, SlideViewer, SlidesBrowser,
  ...
  window.Presentation = (function(_super) {
    ...
    Presentation.prototype.sync = function(method, model, options, error) {
      var attributes;
      switch (method) {
        case 'create':
        case 'update':
